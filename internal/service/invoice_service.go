...
// InvoiceService is a service that handles invoice-related operations
...
// ListByAccount lists all invoices of an user by Account ID
...
// ListByAccountAPIKey lists all invoices of an user by API Key
